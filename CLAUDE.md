...
### Система блокировок
Каждый агент может держать только одну блокировку одновременно (предотвращение дедлоков). При занятости — цикл ожидания с heartbeat-обновлениями. Блокировки снимаются автоматически при `swarm done`.
